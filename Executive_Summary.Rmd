...
This bar chart shows variation of the length of reviews in the combination of room types and the reviews rating category of listings and provides insights on users behaviour. The x-axis is the rating category while the axis is the average number of words. The color represents three room types: Entire home(black), Private room (brown) and Shared room (blue). When it comes to write about experiences, people intend to write longer reviews as they talk about good experiences. By comparing category A and C, we can see that the number of words increases as the good feelngs goes up. While, in terms of room types, there is no difference of the three room types, Entire home/apartment have longer reviews followed by the room type Private room.

...
The vast majority of Airbnb prices lie between \$0 to \$400 per night. The most common prices happen somewhere between \$50 to \$150 depending on the borough. Among the two most popular boroughs, Brooklyn tend to have more cheaper Airbnb places with prices listed most frequently (over 50%) around \$50 to \$100. Overall price distribution in Brooklyn is even more concentrated on the cheaper side-- over 90% of listings are below \$200 per night.
